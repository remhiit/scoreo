...
|---|---|---|---|---|
| Home (players) | `src/ui/home/playerReducer.ts` | `PlayerAction` | `loaded`, `updateInput`, `addSucceeded`, `addFailed`, `showDeleteConfirm`, `dismissDeleteConfirm`, `deleted`, `startRename`, `updateRenameInput`, `renameSucceeded`, `renameFailed`, `cancelRename`, `showCleanupConfirm`, `dismissCleanupConfirm`, `cleanupCompleted` | `src/ui/home/playerTypes.ts` (`PlayerState`, incl. `trophyCounts`) |
