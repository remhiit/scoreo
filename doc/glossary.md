...
| **ServicesContext** | Root React context (`apps/scoreo/src/services/ServicesContext.tsx`) built once via `useMemo`, exposing the concrete repositories and use cases to every screen via `useServices()`. |
