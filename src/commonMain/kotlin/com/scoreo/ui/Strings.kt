...
object Strings {
    ...
    const val MSG_SYNC_DATA_GOOGLE = "Sync your data with Google Drive"
     ...
     const val LABEL_CONNECTING_GOOGLE = "Connecting to Google..."
     const val LABEL_CHECKING_SYNC = "Checking sync status..."
     const val LABEL_SYNCING_DATA = "Synchronising data..."
     const val MSG_NO_CONFLICT_DATA = "No conflict data available"
     const val MSG_CONFLICT_CHOICE = "Two versions of your data differ. Choose which one to keep."
     const val LABEL_LOCAL_VERSION = "Local version"
     const val LABEL_REMOTE_VERSION = "Remote version"
     
     // UI Actions & Titles
     const val TITLE_VIEW_DETAIL = "View details"
     const val TITLE_EDIT = "Edit"
     const val TITLE_DELETE = "Delete"
     const val LABEL_EDIT_GAME = "Edit {name}"
